...
public class RecruiterMapperTests {
    ...
    public void mapperTests() {
        ...
        Recruiter api = new Recruiter(1, 2, "Daniel Lopez",
                "Job Spring Partners", "C", "adr");
        ...
        assertEquals(api.getRecruiterName(), entity.getName());
